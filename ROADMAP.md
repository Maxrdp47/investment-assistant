...
| R2 – Gold/Silber | `BLOCKED_BY_DATA_SEMANTICS` | R1 terminal ohne Holdout-PASS | `GC=F`, `SI=F`, relative Divergenz; Futures-Roll, Sessions, PIT, Next-Open, Kosten und Slippage | 0 | Work Request `4fdfb983-ddbc-4178-bd36-7aa34267df0b` `BLOCKED`; Experiment `255532e0-3b54-412a-a29e-866bfe4bda82` `DRAFT`; [Daten-Gate](GOLD_SILVER_R2_DATA_GATE_2026-09-22.md) in KB referenziert | Daten-/Methodik-Gate vor Research-Freeze und Development nicht bestanden; Validation/Holdout ungeöffnet | keine kontinuierliche Futures-Proxyreihe mit unbekannter Roll-Semantik als handelbare Evidenz ausgeben | R2 bleibt für eine belegbar taugliche Quelle blockiert; programmgemäß R3 ohne R2-Ergebnis prüfen |
| R3 – Overnight/Intraday | `FROZEN_PRE_PILOT` | R2 ohne Holdout-PASS; Contract-Deduplizierung | v7-r2 beantwortet rollierende Komponenten, 1/5/20-Horizonte und Baseline-Inkrement nicht vollständig; genau eine eigenständige deskriptive Version | 0/1 ausgeführt | [Dedupe-/Freeze-Bericht](OVERNIGHT_INTRADAY_R3_DEDUPE_2026-09-22.md), KB-Experiment `8389509b-dc70-41b6-9df9-e27c194f0a04`; Dataset `321531c482d844df4d5513b58646b3f41553f47a7b2276517cb8473886c298d6`; Contract `b908c5803e17e95691a78fee60d9f47ac25b43675091f3fca249ff84f5adcb41` | Pilot/Resume/Integrität vor Vollauf; gesehene v7-Jahre nie als unseen, Dependencies-Effective-N unbekannt | kein Doppeltest, keine neue Schwelle, keine Kombination | sicheren Pilot durchführen; nur danach den einen Development-Versuch fortsetzen |
