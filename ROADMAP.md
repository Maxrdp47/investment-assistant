...
| R4 – Historical/PIT Capability Expansion | `READY_FOR_PREFLIGHT` | R3 terminal ohne Holdout-PASS; keine v2-Outcomes betrachtet | A Identity/Dependencies; B Relative Strength/Struktur; C Fundamentals; D Events; E Makro/Rates; F Politik; G FX; H Crypto; I Survivorship | 0 Research-Versuche; Infrastruktur zählt nicht als Strategie-Attempt | vorhandene Identity-, Equity/ETF-, Crypto-, FX-, COT-, Event-, SEC- und KB-Stores; genaue Fingerprints im Capability Freeze | ausschließlich Coverage, Zeitstempel, Quelle, Missingness, Revisionen und Integrität | keine Capability nach Performance aktivieren; heutige Daten nie rückdatieren; keine minderwertige Ersatzquelle | Daten-/Messlücken isoliert schließen und auditieren |
