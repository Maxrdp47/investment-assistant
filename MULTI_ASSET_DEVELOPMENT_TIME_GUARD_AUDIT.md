...
Der Multi-Asset-Development-Runner besitzt im ausführbaren Contract v4 eine explizite,
...
| Explizite Development-Startgrenze | `config/multi_asset_discovery_development_v4.json`, `multi_asset_development_runner.py` | Verhindert jeden Start vor dem beauftragten Stichtag | In v1/v2 nicht als eigener Contract-Gate vorhanden | **Development-eigen.** Vor 02.09.2026 00:00 CEST geschlossen, ab exakt 00:00 offen. |
...
| Stage-/Unseen-Sperren für Validation, Holdout, External und True Forward | `config/multi_asset_discovery_development_v4.json`, Contract- und Readiness-Gates | Verhindert vorzeitigen Zugriff auf ungesehene Stufen | Geschlossen | **Permanenter Forschungs-Gate.** Bleibt geschlossen. |
| Paper-/Shadow-/Broker-/Order-Sperren | `config/multi_asset_discovery_development_v4.json`, Contract- und Readiness-Gates | Verhindert Handels- oder Produktionsausgaben | Geschlossen | **Permanenter Sicherheits-Gate.** Bleibt geschlossen. |
...
| Serielle SQLite-Schreibvorgänge und getrennte append-only v4-Stores | v4-Contract, `multi_asset_development_execution.py` | Konsistenz, Reproduzierbarkeit und Trennung von v1/v2/v3 | Aktiv | **Datenschutz.** Unverändert aktiv; v1/v2/v3-Stores werden nicht geöffnet oder verändert. |
...
werden nicht gelöscht oder abgeschwächt. Contract v4 klassifiziert ihre
...
erhalten; die technisch getrennte Ausführung erfolgt deshalb über v4.
