...
| R4 – Historical/PIT Capability Expansion | `IN_PROGRESS_A_AUDITED` | R3 terminal ohne Holdout-PASS; keine v2-Outcomes betrachtet | A Identity/Dependencies; B Relative Strength/Struktur; C Fundamentals; D Events; E Makro/Rates; F Politik; G FX; H Crypto; I Survivorship | 0 Research-Versuche; Infrastruktur zählt nicht als Strategie-Attempt | [R4-A-Audit](R4_A_IDENTITY_DEPENDENCY_AUDIT_2026-09-22.md): 2.297 historische Asset-/Listing-Einheiten, 0 verifizierte zeitgenössische Issuer-Cluster; übrige Quell-Fingerprints im Capability Freeze | ausschließlich Coverage, Zeitstempel, Quelle, Missingness, Revisionen und Integrität | keine Capability nach Performance aktivieren; heutige Daten nie rückdatieren; unbekanntes Effective N nicht durch Roh-N ersetzen | R4-B Relative Strength/Struktur kausal prüfen, danach C–I und Capability Freeze |
