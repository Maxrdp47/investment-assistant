...
| R4 – Historical/PIT Capability Expansion | `IN_PROGRESS_A_TO_F_AUDITED` | R3 terminal ohne Holdout-PASS; keine v2-Outcomes betrachtet | A Identity/Dependencies; B Relative Strength/Struktur; C Fundamentals; D Events; E Makro/Rates; F Politik; G FX; H Crypto; I Survivorship | 0 Research-Versuche; Infrastruktur zählt nicht als Strategie-Attempt | [R4-A-Audit](R4_A_IDENTITY_DEPENDENCY_AUDIT_2026-09-22.md): 0 historische Issuer-Cluster; [R4-B-Capability](R4_B_RELATIVE_STRUCTURE_CAPABILITY_2026-09-22.md): globaler ACWI-Fallback und kausale Struktur, Contract `aef8ec16c674f7284884caca3fb040480eba77fbacfc05a23fece5c75ad47901`; [R4-C-Audit](R4_C_FUNDAMENTALS_CAPABILITY_2026-09-22.md): Offline-SEC-PIT-Parser, `SHADOW`; [R4-D/E/F-Quellenaudit](R4_D_E_F_PIT_SOURCE_AUDIT_2026-09-22.md): historische Events/Politik `SHADOW`, Vintage-Makro/Expectations `UNAVAILABLE`, COT `SHADOW` | ausschließlich Coverage, Zeitstempel, Quelle, Missingness, Revisionen und Integrität | keine Capability nach Performance aktivieren; heutige Daten nie rückdatieren; unbekanntes Effective N nicht durch Roh-N ersetzen | R4-G FX prüfen, danach H/I und Capability Freeze |
