...
- Das lokale Registry `research-identity-registry-2026.08.29-unresolved-v1` enthält 2.520 stabile Listings. Der kostenlose offizielle SEC-Massenabruf wurde real versucht, aber vom Anbieter mit HTTP 403 abgewiesen. Deshalb sind 0 Zuordnungen als verifiziert und 2.520 ausdrücklich als `UNRESOLVED` gespeichert. Diese unbekannten Fälle zählen nicht als unabhängig und tragen 0 zum issuerbereinigten effective N bei. Das ist methodisch sicher, reicht aber noch nicht für den großen Multi-Asset-Scan; der Precheck bleibt bis zu einer belastbaren Identitätsquelle `NOT_READY`.
...
- Der reine Datensammler `fx-pit-observer-2026.08.29-v1` besitzt eine eigene append-only Datenbank `runtime/fx_forward_pit.sqlite3`, Process Lock, Idempotenz, Revisionen, Missingness, Source Health, Provenienz und 28 Sperrtrigger. Offline- und Live-Pilot sind abgeschlossen. Der erste echte automatische Lauf startete am 2026-08-29 genau um 21:45 Uhr und endete fehlerfrei mit Exit-Code 0. Nach drei Läufen enthält der Store 18 eindeutige Beobachtungen; im automatischen Lauf wurden 3 neue Beobachtungen ergänzt und 7 Wiederholungen korrekt dedupliziert. Enthalten sind aktuelle tägliche FX-Balken und vier offizielle COT-Beobachtungen; fehlende Policy-Rate-, Erwartungs-/Vintage- und Bid/Ask-Adapter sind als `NO_RELIABLE_DATA` erfasst. Der Windows-Task `InvestmentAssistant-FX-PIT-Observer` läuft täglich um 21:45 Uhr Europe/Berlin, startet verpasste Läufe nach Verfügbarkeit, weckt den Rechner nicht und verhindert Parallelstarts.
...
- Failed Seller Attempts ist als eigener kausaler Development-Feature-Epoch abgeschlossen: Work Request `d4dbaf10-b321-4223-9a0b-91f0bc245151`, Resultat `07f46840-35e1-41f4-949c-264c7cf08fbe`, Feature-Contract-Fingerprint `2768a54a4ee619d4c2c66982cd6f80cf5f950f1c5a8f2c19f45cff53fb15a400`. 379.039/379.039 Pullback-Fälle waren technisch verfügbar, 369.640 besaßen das vorhandene R-Ergebnis; vier präregistrierte Einzelvarianten wurden gezählt, keine Kombination. Genau ein Versuch zeigte +0,1069 R/PF 1,219, genau zwei +0,0979 R/PF 1,204, Close Location ≥0,70 +0,0630 R/PF 1,114 und ≥0,80 +0,0640 R/PF 1,118. Wegen 379.039 unbekannten, nicht als unabhängig zählbaren Issuer-Abhängigkeiten bleibt die Richtung verbindlich `INCONCLUSIVE`; Validation, Holdout, Filter und Strategie bleiben geschlossen.
...
- Technische Abnahme der Multi-Asset-Vorbedingungen: 41 gezielte Identity-/FX-/Failed-Seller-/KB-Tests und die vollständige Suite mit 794/794 Tests bestanden. Vollständige Kompilierung, Repository-Sicherheitscheck, Offline-Smoke, separater Streamlit-Start, Swing-Preflight und Diff-Prüfung sind erfolgreich. Ein manueller Asia-Aufruf endete fail-closed als `legacy_strategy_frozen` und ließ die geschützten Runtime-Dateien unverändert.
