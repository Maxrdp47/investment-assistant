...
- Vor dem Einfrieren des Contracts und Run-Manifests der nächsten historischen Multi-Asset-Kampagne muss aktiv ein kontrollierter Mehr-Worker-Benchmark vorgeschlagen werden. Dabei sind mindestens die bestehende Ein-Worker-Baseline und wenige konservative Worker-Zahlen auf identische Resultate, deterministische Case-Identität, serielles SQLite-Schreiben, RAM-/CPU-Verhalten und Produktionsverträglichkeit zu prüfen. Die schnellste bestandene Konfiguration soll vor dem Kampagnenstart festgelegt werden; ein laufender eingefrorener Run wird nicht nachträglich umgestellt.
