...
| R2 – Gold/Silber | `BLOCKED_BY_DATA_SEMANTICS` | R1 terminal ohne Holdout-PASS | `GC=F`, `SI=F`, relative Divergenz; Futures-Roll, Sessions, PIT, Next-Open, Kosten und Slippage | 0 | Work Request `4fdfb983-ddbc-4178-bd36-7aa34267df0b` `BLOCKED`; Experiment `255532e0-3b54-412a-a29e-866bfe4bda82` `DRAFT`; [Daten-Gate](GOLD_SILVER_R2_DATA_GATE_2026-09-22.md) in KB referenziert | Daten-/Methodik-Gate vor Research-Freeze und Development nicht bestanden; Validation/Holdout ungeöffnet | keine kontinuierliche Futures-Proxyreihe mit unbekannter Roll-Semantik als handelbare Evidenz ausgeben | kein R2-Retune; Datenlücke dokumentiert, Programm über terminales R3 zu R4 fortgesetzt |
| R3 – Overnight/Intraday | `DONE_DEVELOPMENT_NEGATIVE_NO_ROBUST_INCREMENT` | R2 ohne Holdout-PASS; Contract-Deduplizierung | ein eigenständiger, vor Ergebnis eingefrorener deskriptiver Versuch; keine Handelsregel | 1/1 | [R3-Review](OVERNIGHT_INTRADAY_R3_REVIEW_2026-09-22.md); KB-Resultat `3cc7e3a9-47a9-4e01-a20a-fd4e1e6f43d1`; Dataset `321531c482d844df4d5513b58646b3f41553f47a7b2276517cb8473886c298d6`; Contract `b908c5803e17e95691a78fee60d9f47ac25b43675091f3fca249ff84f5adcb41` | partielle Korrelationen nahe null/instabil; Effective N unbekannt; Validation/Holdout ungeöffnet | kein zweiter R3-Versuch, kein Filter, keine neue Schwelle oder Kombination | R4 Capability Expansion beginnen |
| R4 – Historical/PIT Capability Expansion | `DONE_LIMITED_CAPABILITY_A_TO_I` | R3 terminal ohne Holdout-PASS; keine v2-Outcomes betrachtet | A Identity/Dependencies; B Relative Strength/Struktur; C Fundamentals; D Events; E Makro/Rates; F Politik; G FX; H Crypto; I Survivorship | 0 Research-Versuche; Infrastruktur zählt nicht als Strategie-Attempt | [R4-A](R4_A_IDENTITY_DEPENDENCY_AUDIT_2026-09-22.md); [R4-B](R4_B_RELATIVE_STRUCTURE_CAPABILITY_2026-09-22.md); [R4-C](R4_C_FUNDAMENTALS_CAPABILITY_2026-09-22.md); [R4-D/E/F](R4_D_E_F_PIT_SOURCE_AUDIT_2026-09-22.md); [R4-G](R4_G_FX_HISTORICAL_CAPABILITY_2026-09-22.md); [R4-H](R4_H_CRYPTO_CAPABILITY_2026-09-22.md); [R4-I](R4_I_SURVIVORSHIP_UNIVERSE_AUDIT_2026-09-22.md) | nur begrenzte OHLCV-/globale Benchmark-Capabilities aktivierbar; übrige Familien shadow/unavailable/not-testable; Survivorship unbekannt | heutige Daten nie rückdatieren; Unknown nicht als False/0; keine Capability nach Performance aktivieren | R5 Capability Matrix, Missingness-/Seen-Data-/Outcome-/Kosten-/Split-Vertrag vor v2-Outcomes einfrieren |
| R5 – Discovery-v2 Contract Freeze | `DONE_FROZEN_NO_OUTCOMES_OPENED` | R4 abgeschlossen; Smoke #58 für Commit `28ba5d1` grün | Feature-, Source-, Missingness-, Outcome-, Seen-Data-, Kosten- und Split-Vertrag | 0 | [R5-Freeze](R5_MULTI_ASSET_DISCOVERY_V2_FREEZE_2026-09-22.md); Contract `0e67967f5d26b0d6801270fea29188d71f6288ad8ca34a3003e384a81fccd241`; Equity/ETF `321531c482d844df4d5513b58646b3f41553f47a7b2276517cb8473886c298d6`; Crypto `475b78ee3dd0a45371b6dc0448b9d915d0a879dadabe4c2d385573fd1fe6bf91` | 19 Familien klassifiziert; Provenienz-/Missingness-/Stage-/Quality-C-/Safety-Validator `PASS`; keine Outcomes geöffnet | Vertrag nach Ergebnissichtung nicht ändern; Missing nicht zu False/0; Legacy-Stage-ID nicht als SHA ausgeben | nach grünem R5-CI R6-Implementierung, deterministischen Pilot und Integrity Gate vorbereiten |
| R6 – Discovery v2 Development | `DONE_NO_ROBUST_CANDIDATE` | R5 Freeze vollständig; R6-Code-Commit `3dec1b1`; Pilot/Replay/Integrity und Smoke #61 grün | Horizon-spezifische 20/60/120/252-Populationen; 31 vorab benannte Einzelfeatures; keine Massenkombination | 1/1 | Run `mad2-development-v2-20260922-v1`; 60.432/60.432 Receipts; 2.356.553 Fälle; [Final Audit](R6_MULTI_ASSET_DISCOVERY_V2_FINAL_AUDIT_2026-09-22.md) `7a83cc352de0c69e47cf41a7659a9999225aa3a6884424751701e9311a8898b0`; [Descriptive Report](R6_MULTI_ASSET_DISCOVERY_V2_DESCRIPTIVE_DEVELOPMENT_REPORT_2026-09-22.md) `4ee1cdb2193a0103618ffa6887d8da03f65030addaf93fb1231a1db639d46024`; [Completion Summary](R6_MULTI_ASSET_DISCOVERY_V2_COMPLETION_SUMMARY_2026-09-22.md) `917bf73aac6c49bef06c292000d7d526c521e6a2342169ee3e2348d9749e7ce2` | Audit `PASS`; verpflichtende Dimension `DEPENDENCIES` scheiterte mit historisch verifiziertem Effective N = 0; 0 robuste Kandidaten | keine Schwellen-, Ranking-, Kombinations- oder Rettungssuche; Validation/Holdout ungeöffnet | R7 nicht öffnen; R8-Trigger streng prüfen |
| R7 – maximal drei v2-Challenger | `NOT_OPENED_ZERO_ELIGIBLE_CANDIDATES` | R6 Review fand 0 robuste Quality-C-Kandidaten | kein Challenger erzeugt | 0 von maximal 3 | R6 Completion `917bf73aac6c49bef06c292000d7d526c521e6a2342169ee3e2348d9749e7ce2` | kein zulässiger Freeze-Kandidat; Validation/Holdout ungeöffnet | kein Kandidat aus deskriptiver Rangfolge oder kleinen Segmenten ableiten | R8-Trigger prüfen |
| R8 – begrenzte Research Reserve | `SKIPPED_NO_JUSTIFIED_RESERVE_TRIGGER` | kein Holdout-PASS; 0 offene R7-Kandidaten; keine technisch messbare konkrete Informationslücke | kein Reserveindikator getestet | 0 von maximal 2 | [R8 Trigger-Review](FINITE_RESEARCH_PROGRAM_R8_TRIGGER_REVIEW_2026-09-22.md) `15d052c53e10ede584092f86fc044f4d74880b5b278bc60518fa112c7129006e` | offene harte Grenze ist Issuer-/Dependency-Provenienz; Reserveindikatoren können sie nicht messen oder schließen | keine Grid Search, Popularitätsauswahl oder Rettungshypothese | direkt R9 |
| R9 – Gesamtentscheidung und STOP | `DONE_NO_ROBUST_EDGE_FOUND` | R0–R8 terminal; 0 Validation- und 0 Holdout-Stufen verbraucht | vollständiges Ledger, Seen-Data-Register, Capability-/Coverage-Grenzen und Safety-Abschluss | 3 neue empirische Attempts insgesamt | R9 `4cef4088c6fcaf2eee0b8b52975ffe1f8c94e93aad1014d5dab11db484dcf16b`; Seen-Data `89784a4730b73128fa1265b555d69bfb43bdcd75ee4004fa38bf22e28924c549` | `NO_ROBUST_EDGE_FOUND_IN_APPROVED_RESEARCH_PROGRAM` | keine universelle No-Edge-Behauptung; keine weitere automatische Trading-Forschung | `STOP_AWAIT_USER_REVIEW` |

Das endliche Programm ist terminal geschlossen. Kein anderer `READY`-Work-Request und keine außerhalb dieser Tabelle liegende Idee darf als Ersatz ausgewählt werden. Die Software und Research-Infrastruktur bleiben aktiv; ausschließlich bereits autorisierte signalunabhängige Collector dürfen weiterlaufen, sofern sie keinen echten Prozess-, Lock-, DB- oder Ressourcen-Konflikt verursachen.

## Frühere Urlaubs-Workqueue – nicht mehr aktive Steuerkette

Die folgenden TR-Einträge sind historische Planungsreferenzen und keine aktuelle Startfreigabe. Ihre maßgeblichen Ist-Stände stehen ausschließlich oben im endlichen Programm und in `PROJECT_STATUS.md`.
...
- **Ausführungsart:** historischer Queue-Eintrag, durch R1 des endlichen Programms ersetzt.
- **Aktueller Stand:** R1 `DEVELOPMENT_INCONCLUSIVE`, Work Request `COMPLETED`; keine weitere automatische Wasser-Version.
...
- **Nächster zulässiger Schritt:** keiner innerhalb des aktuellen Programms; der einmalige R1-Versuch ist terminal.

### TR-02 – Gold-/Silber-Nachzügler

- **Ausführungsart:** historischer Queue-Eintrag, durch R2 des endlichen Programms ersetzt.
- **Aktueller Stand:** Work Request `BLOCKED` wegen unzureichender Futures-Datenprovenienz; Experiment `DRAFT`; 0 Resultate.
...
- **Nächster zulässiger Schritt:** nur nach Nutzerreview oder belegbar geeigneter und freigegebener Kontrakt-/Roll-/Open-Quelle erneut vorprüfen; kein Performance-Runner auf der ungeklärten Proxyreihe.
