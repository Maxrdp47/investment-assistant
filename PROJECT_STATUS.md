...
- Das Research-Identity-Gate v2 trennt für alle künftigen Research-Epochen `asset_id`, `listing_id` und nur belastbar bekannte `issuer_id`. Ticker, Börse, Währung, Instrumenttyp, Assetklasse, Primär-/Sekundärrolle, ADR/ADS/GDR, ISIN, Handelszeitzone und Gültigkeit bleiben listingbezogen. OHLCV, Kurs, Volumen, Spread, Handelszeiten, technische Marken, Entry, Stop, Ziel, Liquidität und Gaps dürfen nur aus demselben Listing und derselben Währung stammen. Unbekannte Issuer-Abhängigkeit bleibt `UNKNOWN`, zählt nicht als unabhängige Evidenz und trägt 0 zum issuerbereinigten effective N bei. Broad-v1 wurde dafür nicht verändert.
...
- Der FX-Carry-Auftrag `1f6201fe-2cbd-4fc1-9bf1-291a4221bdfa` ist mit Resultat `a4c0b1c7-ab1d-4802-bfc6-48d869843cb6` als transparente Teilpipeline `COMPLETED`. EUR/USD, USD/JPY und GBP/USD besitzen versionierte Basis-/Gegenwährungs-, Inversions-, Vorzeichen-, Session-, Tagesabschluss-, `known_at`-/`available_at`- und Revisionsverträge. Es wurden 0 historische Beobachtungen erfunden: lokale historische Zinsvintages, Erwartungen, Pre-Release-Konsense, bestätigte Interventionen, implied Volatility und Bid/Ask fehlen weiter; COT und Kostenstress bleiben Shadow-Kontext. Keine FX-Auswertung oder Richtungsregel wurde gestartet.
