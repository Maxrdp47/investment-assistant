...
- Backtesting-Basis: Im Analyse-Detailbereich testet die App historische Signal-Kombinationen aus Kaufsignal, RSI, MACD und CRV gegen spätere Kursentwicklungen für 1, 3, 6 und 12 Monate. Die Tabelle zeigt zusätzlich Asset-Typ, damalige Marktphase und maximalen Drawdown je Gruppe und kann lokal in `backtest_history.json` gespeichert werden. Das ist ein Signaltest, keine Strategieoptimierung und keine automatische Kauf-/Verkaufsfunktion.
