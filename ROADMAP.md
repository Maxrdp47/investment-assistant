...
| R6 – Discovery v2 Development | `READY_AFTER_R5_CI_AND_PILOT` | R5 Freeze vollständig; R5-CI grün; Implementierung, Integrity-/Replay-Pilot `PASS` | Horizon-spezifische 20/60/120/252-Populationen; Einzelfeatures/-familien; keine Massenkombination | 0 | Run `mad2-development-v2-20260922-v1`; neue append-only Stores; R5-Fingerprints | vollständiger vorab definierter deskriptiver Review und kanonisches C-/Robustheitsgate | keine Validation während Discovery; kein Gesamt-Score; keine Top-Auswahl nach Profit | Implementierung/Test → Pilot/Replay/Integrity → erst dann Full Development automatisch starten |
