...
- Opportunity Scanner: In der Sidebar kann eine kleine Watchlist gescannt werden. Die App nutzt vorhandene Analysefunktionen, zeigt Top-Long-Chancen, Short-/Absicherungs-Kandidaten, Opportunity Score, Vertrauensscore, Zeithorizont, News, Makro, Liquidität, Bewertung, institutionelle Faktoren, ähnliche historische Setups, Trefferquote ähnlicher Setups und wichtigste Begründungen. Fehlende Faktorquellen werden als `Daten nicht verfügbar` angezeigt. Bereits geladene Yahoo-Stammdaten werden im Scanner wiederverwendet, damit große Watchlists keine unnötigen Doppelabfragen erzeugen. Der Scanner macht nur Vorschläge und führt keine Käufe oder Verkäufe aus.
- Trading-Modus: Es werden nur Kandidaten aus dem Opportunity Scanner analysiert. Für jedes Setup werden Richtung, Chance, Confidence, Zielzone, Stop-Zone, Zeithorizont, CRV, Risiken, Chancen, ähnliche Setups, Trefferquote und Historienstatus angezeigt.
- Trade Journal: Vorgeschlagene Trading-Setups werden beim Scannerlauf automatisch lokal in `trade_history.json` dokumentiert und nach Ticker/Richtung/Tag dedupliziert. Neue und ältere Feldnamen werden beim Speichern defensiv normalisiert, damit Performance Tracking, Historienstatus und ähnliche Setups konsistent nutzbar bleiben. Es wird keine Order ausgeführt und keine Broker-Verbindung genutzt.
- Performance Tracking: Gespeicherte Trading-Setups können nach 1 Woche, 1 Monat, 3 Monaten, 6 Monaten und 12 Monaten mit echten Kursdaten überprüft werden. Erfasst werden Treffer/Fehlschlag, Rendite, maximale positive Entwicklung, maximale negative Entwicklung, Ziel- und Stop-Berührung, beste Alternative, Opportunitätskosten sowie Historienkontext aus ähnlichen Setups.
