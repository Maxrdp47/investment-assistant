...
| R4 – Historical/PIT Capability Expansion | `IN_PROGRESS_A_TO_H_AUDITED` | R3 terminal ohne Holdout-PASS; keine v2-Outcomes betrachtet | A Identity/Dependencies; B Relative Strength/Struktur; C Fundamentals; D Events; E Makro/Rates; F Politik; G FX; H Crypto; I Survivorship | 0 Research-Versuche; Infrastruktur zählt nicht als Strategie-Attempt | [R4-A-Audit](R4_A_IDENTITY_DEPENDENCY_AUDIT_2026-09-22.md): 0 historische Issuer-Cluster; [R4-B-Capability](R4_B_RELATIVE_STRUCTURE_CAPABILITY_2026-09-22.md): globaler ACWI-Fallback und kausale Struktur; [R4-C-Audit](R4_C_FUNDAMENTALS_CAPABILITY_2026-09-22.md): SEC-Parser, `SHADOW`; [R4-D/E/F-Quellenaudit](R4_D_E_F_PIT_SOURCE_AUDIT_2026-09-22.md): Events/Politik/COT `SHADOW`, Vintage-Makro/Expectations `UNAVAILABLE`; [R4-G-FX-Audit](R4_G_FX_HISTORICAL_CAPABILITY_2026-09-22.md): historisch nicht testbar; [R4-H-Crypto-Capability](R4_H_CRYPTO_CAPABILITY_2026-09-22.md): kausale BTC-relative OHLCV-Merkmale nur im eingefrorenen Universum, Contract `5020eab57a4c2b60f81677bacff0b905a50f79fa30144b75e508f61e9e02dd51` | ausschließlich Coverage, Zeitstempel, Quelle, Missingness, Revisionen und Integrität | keine Capability nach Performance aktivieren; heutige Daten nie rückdatieren; unbekanntes Effective N nicht durch Roh-N ersetzen | R4-I Survivorship prüfen, danach Capability Freeze |
