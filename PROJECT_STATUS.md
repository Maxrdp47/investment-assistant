...
## Buyer-Confirmation-Challenger v1 – terminaler Validation- und Provenienzstand 2026-08-28
...
- Die laufende historische Kampagne steht am zuletzt geprüften 2026-08-23 bei 247/248 Jobs beziehungsweise 99,60 %. Runde A und B sind mit jeweils 80/80 abgeschlossen, Runde C steht bei 79/80; der letzte C-Shard läuft seit 01:25 Uhr. Der breite Runner bleibt bis zu dessen Abschluss gesperrt und verändert weder Queue noch Fälle, Dataset oder Kampagnendatenbank.
...
- Die Shadow-Live-Grundlage erzeugt aus aktuellen Signalen denselben Orderentwurf, der später einem Live-Pfad zugrunde liegen könnte, überträgt ihn aber niemals. Drei getrennte Entwürfe und drei append-only Execution-Missingness-Sidecars sind gespeichert. Eine belastbare kostenlose automatische Read-only-Quotequelle für die konkreten Listings ist nicht vorhanden: 0 echte Bid-/Ask-Quotes, 0 echte Trade-only-Beobachtungen, 0 Fill-/Teilfill-/Slippage-/Orderbuch-/Brokerablehnungs-Evidenzen. Beobachtete Marktdaten, theoretischer Entwurf, spätere Auswertung und simulierte Kosten sind getrennt; nichts davon wird geschätzt.
...
- Die technische Challenger-Kampagne ist mit zuletzt 247/248 Jobs noch nicht vollständig; der letzte C-Shard läuft. Solange er und der abschließende Robustheitsvergleich fehlen, darf aus Teilkennzahlen weder ein Sieger noch eine Produktionsänderung abgeleitet werden.
