...
- Die Erweiterung `fx-historical-pit-2026.08.29-v1` speichert für die drei Hauptpaare 12.779 unveränderte tägliche OHLC-Kursbeobachtungen vom 2010-01-01 bis 2026-08-28. Verfügbarkeit beginnt konservativ erst 15 Minuten nach dem kanonischen New-York-Tagesabschluss. Der damalige Import meldete 229 unter seiner engeren Prüfung verworfene Anbieterbalken; der spätere Discovery-v1-Pilot belegte zusätzlich 231 im Store verbliebene Hüllenverletzungen, bei denen Open oder Close außerhalb von High/Low liegt. Deshalb ist dieser FX-Preisbestand noch nicht Development-ready. Tatsächliche historische Policy Rates, Zinserwartungen, Makro-Vintages, Pre-Release-Konsense, Surprises, Interventionen und Bid/Ask fehlen weiterhin und wurden nicht geschätzt. COT bleibt eine getrennte offizielle Pipeline mit eigenem Release-Gate; Kosten bleiben ausdrücklich Proxy-Vertrag ohne erfundene Werte.
...
- Der kleine technische Integritätspilot über exakt elf feste Fälle ist abgeschlossen. 18/19 Gates bestehen; Determinismus, Point-in-Time/Next-Open, Safe-Zonen, nur anhebbarer Ratchet, getrennte Intraday-/Close-Breaches, Sell-Zonen, 20/60/120/252-Checkpoints, MFE/MAE/strukturelles R, Stage-Censoring, Dependency-Fail-Closed, Assetklassen-Trennung, Store-Integrität, Append-only-Resume und deduplizierte Wiederholung sind grün. Case-Digest: `f97bbff722535635d03dd41f3848c4a47b1ee6482180dd1765946aae3b64af16`; authoritative Pilot-Fingerprint: `3ef0864fd0e4c94e1d20e069fcbd14516d5b8c9c5924dd819469b862949374a7`.
- Verbindlicher Discovery-Endstatus ist `NOT_READY_TO_START_MULTI_ASSET_DISCOVERY_V1_DEVELOPMENT`. Ein reales FX-Datenintegritätsproblem blockiert den Start: EUR/USD, GBP/USD und USD/JPY enthalten bis zum Pilotsignal 50/26/88 sowie im 252er Outcome 3/6/2 Balken, bei denen Open oder Close außerhalb der gemeldeten High-/Low-Hülle liegen; über den vollständigen lokalen FX-Bestand sind es 68/42/121 beziehungsweise 231. Kein Wert wurde repariert oder imputiert. Außerdem tragen die elf historisch unbekannten Pilot-Dependencies konsequent null zum issuer-adjustierten effective N bei. Vollständiger Nachweis: `research_reports/MULTI_ASSET_DISCOVERY_V1_CONTRACT_AND_PILOT_2026-08-31.md`.
- Produktionswirkung dieses Auftrags: keine. Der große Development-Scan wurde nicht gestartet; Validation, Holdout, External, True Forward, Paper, Shadow, Broker und automatische Orders blieben geschlossen. Frozen Dataset, Broad-v1, Buyer, Failed-Seller, bestehende Forward-/Nutzerdaten und der finale Precheck blieben hash-identisch unverändert.
- Lokale Abschlussabnahme des Discovery-v1-Contract-/Pilotstands: 41 gezielte Contract-/PIT-/FX-/Identity-/Store-Tests und 862/862 vollständige Regressionstests bestanden. `python -m compileall .`, Repository-Sicherheitscheck, Offline-Smoke, separater lokaler Streamlit-Start mit HTTP 200, SQLite-Quick-Checks, WAL-Checkpoint, idempotenter Pilot-Resume und `git diff --check` sind erfolgreich.
