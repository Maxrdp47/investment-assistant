...
- Krypto-Zyklus: nur bei Krypto-Assets, mit Datenabdeckung, Bitcoin-Halving-Einordnung, Krypto-Volatilität, Volumen-/Liquiditätsvergleich und Marktstruktur über 50er/200er-Durchschnitt. ETF-Flows, Fear & Greed, On-Chain-Daten, Orderbuch, Spread und Stablecoin-Liquidität bleiben `Daten nicht verfügbar`, wenn keine belastbare Quelle eingebunden ist.
...
- Trade Journal: Vorgeschlagene Trading-Setups werden beim Scannerlauf automatisch lokal in `trade_history.json` dokumentiert und nach Ticker/Richtung/Tag dedupliziert. Es wird keine Order ausgeführt und keine Broker-Verbindung genutzt.
- Performance Tracking: Gespeicherte Trading-Setups können nach 1 Woche, 1 Monat, 3 Monaten, 6 Monaten und 12 Monaten mit echten Kursdaten überprüft werden. Erfasst werden Treffer/Fehlschlag, Rendite, maximale positive Entwicklung, maximale negative Entwicklung sowie Ziel- und Stop-Berührung.
