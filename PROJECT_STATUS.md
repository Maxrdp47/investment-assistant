...
- Der Nutzer hat den endlichen Research-Programmzyklus `finite-research-program-2026-09-15-v1` von R0 bis spätestens R9 ausdrücklich gestartet und am 2026-09-22 mit „weiter“ fortgesetzt. R0 und der einzelne R1-Wasser-Versuch sind abgeschlossen. R2 Gold/Silber scheiterte **vor jedem Performance-Lauf** am Futures-Daten-/Methodik-Gate. Die frühere Einstufung als globaler technischer Stop ist überholt. R3 ist nach einem einzigen deskriptiven Development-Versuch terminal ohne robusten Zusatznutzen. R4-A ist als Identity-/Dependency-Audit abgeschlossen; R4-B besitzt einen kausalen, eng begrenzten ACWI-/Struktur-Capability-Pilot. R4-C hat einen getesteten Offline-SEC-PIT-Parser, aber keine aktive historische Fundamentals-Coverage (`SHADOW`). R4-D/E/F sind outcome-frei geprüft: lokale Events/Politik und COT nur `SHADOW`, Makro-Vintages/Expectations `UNAVAILABLE` für 2016–2021. R4-G ist `FX_HISTORICAL_DISCOVERY_NOT_TESTABLE` wegen 0 Gap-sicherer 220er-Segmente. R4-H besitzt nur kausale, beobachtende BTC-relative Crypto-OHLCV-Merkmale im eingefrorenen Scope (`ACTIVE_PIT_LIMITED_SCOPE`); On-Chain und Dominanz fehlen. R4-I und R5–R9 sind noch offen.
...
R0 bleibt abgeschlossen und v7-r2 immutable mit 0 robusten Kandidaten. R1 ist als unterpowerter Einzelversuch terminal. R2 ist vor Research-Freeze/Development an der fehlenden überprüfbaren Kontrakt-/Roll-/Open-Provenienz blockiert. Der [einzige R3-Versuch](OVERNIGHT_INTRADAY_R3_REVIEW_2026-09-22.md) ist nach 2.297 Asset-/Listing-Einheiten abgeschlossen: medianes partielles r für 1/5/20 Sitzungen +0,0041/+0,0012/−0,0103, zeitlich instabil und nur auf bereits gesehenen Development-Daten. KB-Resultat `3cc7e3a9-47a9-4e01-a20a-fd4e1e6f43d1`, kein Challenger; Validation und Holdout ungeöffnet. Der [R4-A-Audit](R4_A_IDENTITY_DEPENDENCY_AUDIT_2026-09-22.md) fand 0 historisch verifizierte Issuer-Cluster trotz 2.078 heute verifizierter Mappings für aktive Einheiten; Effective N bleibt 0 nach konservativer Policy. Die [R4-B-Capability](R4_B_RELATIVE_STRUCTURE_CAPABILITY_2026-09-22.md) verwendet nur einen streng früheren ACWI-Schluss und kausale Struktur, ohne Region-/Sektoranspruch oder v2-Outcomes. Die [R4-C-Capability](R4_C_FUNDAMENTALS_CAPABILITY_2026-09-22.md) hat nur einen getesteten Offline-SEC-Parser; mangels Quellsnapshot und historischer CIK-Zuordnung bleiben Fundamentals `SHADOW`, mit 0 belegten historischen Signalzeilen. Der [R4-D/E/F-Audit](R4_D_E_F_PIT_SOURCE_AUDIT_2026-09-22.md) fand lokal nur 24 forward-beobachtete Firmen-Events aus 2026 und COT-Reportdaten frühestens 2023, aber keine verifizierte Event-/Makro-/Politik-Coverage für 2016–2021; historische Events/Politik/COT bleiben `SHADOW`, Vintage-Makro/Expectations `UNAVAILABLE`. Der [R4-G-FX-Audit](R4_G_FX_HISTORICAL_CAPABILITY_2026-09-22.md) bestätigte 0 zulässige Signale: maximale zusammenhängende FX-Segmente nur 194/148/75 Balken statt mindestens 220 plus Entry; keine Wochenenden als Gaps erfunden. Status `FX_HISTORICAL_DISCOVERY_NOT_TESTABLE`, kein FX-Edge-Urteil. Die [R4-H-Crypto-Capability](R4_H_CRYPTO_CAPABILITY_2026-09-22.md) kann auf eingefrorenen Daten beobachtend und um einen Tag verzögert BTC-relative Rendite, Volatilität, relatives gemeldetes Volumen und Struktur berechnen; 29 aktive Coins, BTC/ETH-Pilot ohne Outcomes, nur `ACTIVE_PIT_LIMITED_SCOPE`, keine On-Chain-/Dominanzdaten. R4-I offen, R5–R9 geschlossen. External, Forward, Paper, Shadow-Ausführung, Broker, Orders und Produktion bleiben geschlossen.
