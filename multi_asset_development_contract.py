...
DEFAULT_DEVELOPMENT_OVERLAY = (
    PROJECT_ROOT / "config" / "multi_asset_discovery_development_v3.json"
)
DEVELOPMENT_CONTRACT_VERSION = (
    "multi-asset-opportunity-discovery-development-2026.09.01-v3"
)
DEVELOPMENT_CONTRACT_ARTIFACT_VERSION = (
    "multi-asset-development-contract-artifact-2026.09.01-v3"
)
DEVELOPMENT_CONTRACT_DIFF_VERSION = (
    "multi-asset-development-contract-diff-2026.09.01-v3"
)
